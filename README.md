...
- [ABAP OpenAPI UI v2, a long overdue update!](https://blogs.sap.com/2022/03/31/abap-openapi-ui-v2-a-long-overdue-update/) (10 months ago)
- [A Fiori Launchpad Sandbox for all your CAP-based projects – Sample project setup](https://blogs.sap.com/?p=1507695) (10 months ago)
...
- [marianfoo/gh-following-to-rss](https://github.com/marianfoo/gh-following-to-rss) - Create a OPML File out of your GitHub Following (1 month ago)
...
- [geert-janklaps/cds-launchpad-plugin-demo](https://github.com/geert-janklaps/cds-launchpad-plugin-demo) - cds-launchpad-plugin demo repository (SAP Inside Track / SAP TechEd 2022) (2 months ago)
- [geert-janklaps/cds-launchpad-plugin](https://github.com/geert-janklaps/cds-launchpad-plugin) - Launchpad Plugin for demo / development / testing SAP CAP-based projects (2 months ago)
- [dotabap/dotabap-list](https://github.com/dotabap/dotabap-list) - ABAP Open Source List, https://dotabap.org (4 months ago)
...
- [rezanid/visiostencilfactory](https://github.com/rezanid/visiostencilfactory) - Create Visio stencils from SVG files - 28 stars
